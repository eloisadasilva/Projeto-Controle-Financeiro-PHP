...
if (isset($_GET['cod']) && is_numeric($_GET['cod'])) {
    ...
    //Para verificar se tem alguma coisa dentro do array $dados
    if (count($dados) == 0) {
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5>Aqui você pode alterar sua categoria: </h5>
                ...
                <form method="POST" action="alterar_categoria.php">
                    ...
                    <div class="form-group" id="divCategoria">
                        ...
                        <input class="form-control" placeholder="Digite a categoria. Exemplo: Conta de luz" name="nomecategoria" id="nomecategoria" value="<?= $dados[0]['nome_categoria'] ?>" maxlength="35"/>
                    </div>
                    <button type="submit" onclick="return ValidarCategoria()" class="btn btn-success" name="btnAlterar">Alterar</button>
