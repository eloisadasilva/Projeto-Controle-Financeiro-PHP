...
class Conexao
{
    ...
    /** @var PDO */ // classe específica do php para trabalhar com banco de dados MSQLI também pode ser utilizado, só que o MSQLI é só para MySQL
    ...
    private static function Conectar()
    {
        ...
        return  self::$Connect; //self é para chamar uma função dentro da própria classe
    }
